                    ...
                    <form action="edita_usuario.php" method=POST>
                        <div  >
                            ...
                            <div style ="margin-left:inherit ">
                                <div class="panel panel-default" style="color: #080808; width:922px;  "  >
                                    <div class="panel-heading" style="width: 920px;  " >ADMINISTRADOR : <?php echo $_SESSION['nombre']." ".$_SESSION['apellido'];?></div>
                                    <h2> </h2>
